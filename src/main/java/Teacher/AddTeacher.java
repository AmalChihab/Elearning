...
public class AddTeacher extends javax.swing.JFrame {
    ...
    /**
     * NEW PAGE : BACK TO TEACHER DASHBROAD
     */
    ...
    /**
     * INSERT THE NEW TEACHER IN THE DATABASE
     */
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try{
            ...
            String sql= "insert into User(username , password , type  , NumClass) values(?,?,?,?)";

            PreparedStatement ptstmt= conn.prepareStatement(sql);
            ptstmt.setString(1, name.getText());
            ptstmt.setString(2, password.getText());
            ptstmt.setString(3, "teacher");
            ptstmt.setString(4, classe.getText());
