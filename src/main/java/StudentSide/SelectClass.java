...
public class SelectClass extends javax.swing.JFrame {
     ...
     */
    public SelectClass (int id , String username) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            System.out.println("id : tech : "+StudentSelected);
            String sql = "select idClass , NomClass from Class , User where idClass = NumClass and idUser="+StudentSelected;
